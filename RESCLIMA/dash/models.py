...
class DashboardSettings(models.Model):
    ...
    is_public = models.BooleanField(
        _("Publico"),
        default=False,
        help_text=_("Hace que su producto sea visible al publico. "
                    "La visibilidad de los productos se puede ajustar por separado "
                    "para cada producto, sin embargo configurar este dashboard "
