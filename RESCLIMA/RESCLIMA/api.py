...
router.register(r'd3_pie_chart_censo/(?P<start_date>[-\w]+)/(?P<end_date>[-\w]+)/(?P<description>[-\w]+)', api_views.Censo, base_name='d3_pie_chart_censo') # OK    
# Grafico de barras para los investigadores de cambio climatico
router.register(r'd3_bar_chart_censo/(?P<start_date>[-\w]+)/(?P<end_date>[-\w]+)', api_views.CensoBar, base_name='d3_bar_chart_censo') # OK
